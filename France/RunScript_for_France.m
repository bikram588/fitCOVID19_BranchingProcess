...
[dates, newcases_hist, totalcases_hist] = readWorldometerData('France');
...
Im_sgm = Im_mu*1.3;   % chosen so that the confidence intervals correspond to the historical volatility. We choose a model for Im, such that E(Im)/sigma(Im)=const
